  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="px-5 py-14 sm:px-10 sm:py-20 lg:py-24"><div className="mx-auto max-w-xl">
        ...
        <p className="mt-3 text-sm text-white/50">Read the <a className="text-[#d6a84f] underline underline-offset-4 hover:text-[#ebbe67]" href="/kaam/privacy-policy">KAAM Privacy Policy</a>.</p>
